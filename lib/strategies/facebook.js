...
exports.init = function (conf, app) {
    ...
    passport.use(new Strategy({
        ...
        callbackURL: conf.ssl_base + 'auth/facebook/callback'
    }, exports.callback));

    app.get('/auth/facebook',
        passport.authenticate('facebook', {scope: conf.facebook.scope ? conf.facebook.scope.split(' ') : [ 'public_profile,email' ] }));
